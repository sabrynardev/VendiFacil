...
from app.api.routes import accounts, audit, auth, cash_registers, categories, customers, dashboard, financial, inventory, management_inventory, products, profiles, purchases, reports, sales, suppliers, users
